...
densidad_°P = st.number_input("Ingresa la densidad en °P de la cerveza (Grados Plato):", min_value=0.0, step=0.1)

# Cálculo del Pitch Rate en M células/mL
if levadura == "Levadura Recuperada":
    pitch_rate = 0.75 * densidad_°P  # Pitch rate para levadura recuperada
else:
    if densidad_°P > 1060:
        pitch_rate = 2 * densidad_°P  # Pitch rate para levadura propagada (si densidad > 1060)
    else:
        pitch_rate = 1.5 * densidad_°P  # Pitch rate para levadura propagada normal
